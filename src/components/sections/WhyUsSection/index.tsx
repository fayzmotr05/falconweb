    ...
    <SectionWrapper background="darker" spacing="lg">
      <div className="relative">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none hidden md:block">
          <div className="absolute top-0 right-0 w-96 h-96 bg-neon-cyan/5 rounded-full blur-[60px]" />
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-neon-purple/5 rounded-full blur-[60px]" />
        </div>
